...
I'm a Bot to Convert Other MDisk Links to your MDisk Links or Short Other Links to Tnlinks.in Links by Using your API. 
...
`👨‍💻 Developer:` [Dev](t.me/Moksh_b658)
`📢 Support:` [Talk Bot](https://t.me/greymatters_bots_discussion)
`🌐 Source Code:` [GitHub](https://github.com/GreyMatter658/Tnlinks_Mdisk_bot_repo)
"""
...
> `mtlink` - Change all the links of the post to your MDisk account first and then short to tnlinks.in link.

> `tnlinks` - Short all the links of the post to tnlinks.in link directly.
